...
DivingSurveyResponse divingSurveyResponseFromJson(String str) => DivingSurveyResponse.fromJson(json.decode(str));

String divingSurveyResponseToJson(DivingSurveyResponse data) => json.encode(data.toJson());
...
class DivingSurveyResponse {
    ...
    factory DivingSurveyResponse.fromJson(Map<String, dynamic> json) => DivingSurveyResponse(
