...
import 'package:diver/pages/diver_team_infor.dart';
...
class Routes {
  ...
  static const information_diver = "/diver_team_infor";
...
class RouterGenerator {
  static final pages = [
    ...
    GetPage(
      name: Routes.information_diver,
      page: () => const DiverTeamInformation(),
      binding: Binding(),
    ),
    GetPage(
